...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://mernbackend-kfws.onrender.com/api/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://mernbackend-kfws.onrender.com/api/createuser", {
      // credentials: 'include',
